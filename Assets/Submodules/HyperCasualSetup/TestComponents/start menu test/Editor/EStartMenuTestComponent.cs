...
namespace Mobge.Test {
    [CustomEditor(typeof(StartMenuTestComponent))]
    public class EStartMenuTestComponent : EComponentDefinition {
        public override EditableElement CreateEditorElement(BaseComponent dataObject) {
            return new Editor(dataObject as StartMenuTestComponent.Data, this);
        }
        public class Editor : EditableElement<StartMenuTestComponent.Data> {
            //private bool _editMode = false;
            public Editor(StartMenuTestComponent.Data component, EComponentDefinition editor) : base(component, editor) { }
