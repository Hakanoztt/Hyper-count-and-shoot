...
{
    public class MultiplePrefabSpawnerComponent : ComponentDefinition<MultiplePrefabSpawnerComponent.Data>
    {
        [Serializable]
        public class Data : BaseComponent, IRotationOwner, IChild
        {
            ...
            [HideInInspector, SerializeField] private Quaternion _rotation;
            ...
            private ActionManager.Routine _spawnRoutine;
            ...
            private void StartSpawnRoutine() {
                if (!_spawnStarted) {
                    ...
                    _spawnStarted = true;
                    _spawnRoutine.EnsureRunning(_initArgs.player.FixedActionManager, SpawnUpdate);
                }
            }
            ...
            public void Init(int index) {
                Pose p = new Pose(position, _rotation);
